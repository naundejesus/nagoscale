...
$pageTitle = 'Todos los alojamientos disponibles';
?>
<!doctype html>
<html lang="es">
<head>
...
<meta name="description" content="Explora todos los apartamentos disponibles en <?= e(brand_name()) ?>, de todos nuestros propietarios.">
...
<section class="ne-hero">
  <div class="ne-hero-inner">
    <h1>Todos los alojamientos disponibles</h1>
    <p>Explora el catálogo completo de apartamentos publicados por nuestros propietarios.</p>
  </div>
</section>
...
<div class="container" style="padding-top:0;">
  ...
  <div class="ne-results-layout con-mapa">
    <aside class="ne-filters" id="ne-filters">
      ...
      <a href="alojamientos.php" class="btn-link">Restablecer filtros</a>
    </aside>
    ...
    <div>
      <?php if (!$apartamentos): ?>
        <div class="ne-empty">
          ...
          <a href="alojamientos.php" class="btn btn-primary">Modificar búsqueda</a>
        </div>
      <?php else: ?>
        <div class="ne-grid">
...
<script>
  ...
  if (puntos.length) {
    var mapa = L.map('ne-map').setView([puntos[0].lat, puntos[0].lng], 6);
